...
void solve(){
    ...
    // Minimum number of buses (use as many 6-wheel buses as possible)
    long long mini = n / 6;
    if(n % 6 != 0) mini++;  // add one bus if there is leftover

    // Maximum number of buses (use as many 4-wheel buses as possible)
    long long maxi = n / 4;
